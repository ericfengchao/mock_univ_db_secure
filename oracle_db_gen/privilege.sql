...
GRANT SELECT ON course_enrollment TO guest;
GRANT SELECT ON grade TO guest;
GRANT SELECT ON school_fee TO guest;
GRANT SELECT ON loan TO guest;
GRANT SELECT ON staff_salary TO guest;
...
GRANT SELECT ON school_fee TO professor;
GRANT SELECT ON loan TO professor;
GRANT SELECT ON staff_salary TO professor;
...
GRANT SELECT ON grade TO op_staff;
GRANT SELECT ON school_fee TO op_staff;
GRANT SELECT ON loan TO op_staff;
...
GRANT SELECT ON school_fee TO op_director;
GRANT SELECT ON loan TO op_director;
...
GRANT SELECT ON course_enrollment TO fn_staff;
GRANT SELECT ON grade TO fn_staff;
...
GRANT SELECT ON course_enrollment TO fn_director;
GRANT SELECT ON grade TO fn_director;
