...
academic_insert_sql = 'INSERT INTO academic_year (start_year, end_year)\nVALUES\n' + ',\n'.join(['({},{})'.format(
...
semster_start_end_dates = [('-08-01 00:00:00+08','-12-31 00:00:00+08'), ('-01-01 00:00:00+08','-05-31 00:00:00+08')]
...
semster_insert_sql = 'INSERT INTO semester (semester, start_date, end_date, academic_year_id)\nVALUES\n' + ',\n'.join(['({},{},{},{})'.format(
    str(semster[i]),
...
specialization_insert_sql = 'INSERT INTO specialization (name, index, school_id)\nVALUES\n' + ',\n'.join(['({},{},{})'.format(
...
admin_officer_insert_sql = 'INSERT INTO admin_officer (id, first_name, last_name, gender, email, office_address, office_postal, office_tel, school_id)\nVALUES\n' + ',\n'.join(['({},{},{},{},{},{},{},{},{})'.format(
...
professor_insert_sql = 'INSERT INTO professor (id, first_name, last_name, gender, email, office_address, office_postal, office_tel, school_id)\nVALUES\n' + ',\n'.join(['({},{},{},{},{},{},{},{},{})'.format(
...
student_insert_sql = 'INSERT INTO student (id, first_name, last_name, gender, matric_no, email, address, postal, tel, specialization_id)\nVALUES\n' + ',\n'.join(['({},{},{},{},{},{},{},{},{},{})'.format(
...
loan_insert_sql = 'INSERT INTO loan (amount, start_date, due_date, paid_amount, student_id)\nVALUES\n' + ',\n'.join(['({},{},{},{},{})'.format(
    str(loan_amount[i]),
...
course_insert_sql = 'INSERT INTO course (index, name, description, specialization_id)\nVALUES\n' + ',\n'.join(['({},{},{},{})'.format(
    str(course_index[i]),
...
course_schedule_insert_sql = 'INSERT INTO course_schedule (course_id, semester_id, professor_id)\nVALUES\n' + ',\n'.join(['({},{},{})'.format(
...
school_fee_insert_sql = 'INSERT INTO school_fee(student_id,semester_id,school_fee,school_fee_paid)\nVALUES\n' + ',\n'.join(['({},{},{},{})'.format(
